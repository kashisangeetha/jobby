...
class AllJobs extends Component {
  ...
  onGetProfileFailureView = () => (
    <div className="failure">
      <button className="btn" type="button" onClick={this.onRetryProfile}>
        retry
      </button>
    </div>
  )
  ...
  onGetJobsFailureView = () => (
    <div className="failure">
      <img src={failureViewImg} className="failure" alt="failure view" />
      <h1>Oops! Something Went Wrong</h1>
      <p>we cannot seems</p>
      <div className="button">
        <button className="btn" type="button" onClick={this.onRetryJobs}>
          retry
        </button>
      </div>
    </div>
